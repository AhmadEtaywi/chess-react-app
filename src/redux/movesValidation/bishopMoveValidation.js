export const isBishopMoveValid = (
  ...
  if (squares[endRow][endCol] === "K" && squares[endRow][endCol] !== squares[startRow][startCol]) {
    // white bishop kill the black king
    alert("the black king is dead , Player 1 WIN")
    window.location.reload()
  }
  else if(squares[endRow][endCol]=== "k" && squares[endRow][endCol]!== squares[startRow][startCol]){
